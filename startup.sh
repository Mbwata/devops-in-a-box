...
docker run --name diab_jenkins --network=diabnet -d -p 8481:8080 -v /Users/matthouse/docker/volumes/diab/jenkins/jenkins_home:/var/jenkins_home diab_jenkins
...
docker run -d -p 9081:8081 -p 8082:8082 --network=diabnet --name diab-nexus -v /Users/matthouse/docker/volumes/diab/nexus/nexus-data:/nexus-data diab_nexus
